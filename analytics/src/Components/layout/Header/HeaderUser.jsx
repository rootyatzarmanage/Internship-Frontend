...
export default function HeaderUser() {
    ...
    return (
        <div ref={userMenuRef} className="layout-header-user relative shrink-0">
            <button
                type="button"
            ...
            {isUserMenuOpen && (
                <div role="menu" className="layout-user-menu absolute right-0 top-full mt-4 h-[220px] w-[210px] rounded-xl border border-[#d2d2d2] bg-white p-4 shadow-lg dark:border-[#303030] dark:bg-[#1d1d1d]">
