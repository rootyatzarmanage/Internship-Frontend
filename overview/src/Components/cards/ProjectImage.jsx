    ...
    <section className="flex w-full flex-col overflow-hidden rounded-xl border border-[#bbbbbb] bg-white p-3 shadow-[0_1px_2px_rgba(0,0,0,0.04)]" aria-labelledby="project-image-title">
      <div className="relative flex items-center justify-between" ref={menuRef}>
        ...
        <button
          ...
          aria-haspopup="menu"
          className="cursor-pointer rounded-md p-1 text-[#686868] transition-colors hover:bg-[#f1f3f5] focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#008cd2]"
        ...
        {isMenuOpen && (
          <div className="absolute right-0 top-10 z-20 w-40 rounded-2xl border border-[#e0e4e8] bg-white p-2 shadow-[0_8px_20px_rgba(0,0,0,0.1)]" role="menu" aria-label="Project image actions">
            <button type="button" role="menuitem" className="cursor-pointer block w-full rounded-lg px-3 py-2 text-left text-[13px] text-[#52627a] transition-colors hover:bg-[#f5f7f9] focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#008cd2]" onClick={() => setIsMenuOpen(false)}>View More</button>
            <button type="button" role="menuitem" className="cursor-pointer block w-full rounded-lg px-3 py-2 text-left text-[13px] text-[#52627a] transition-colors hover:bg-[#f5f7f9] focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#008cd2]" onClick={() => setIsMenuOpen(false)}>Delete</button>
          </div>
        )}
      </div>
