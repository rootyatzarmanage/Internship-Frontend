...
export default function PaymentChart() {
  return (
    <section className="h-[374px] w-[613px] rounded-lg border border-[#bbbbbb] bg-[#f8f8f8] p-4 shadow-[0_0_0_1px_rgba(0,0,0,0.01)]" aria-labelledby="payment-title">
      <h2 id="payment-title" className="text-[18px] font-semibold text-[#2a2a2a]">Payment</h2>
      <div className="mx-auto mt-4 flex h-[290px] w-full max-w-[571px]">
        ...
        <div className="relative flex-1">
          ...
          <div className="relative flex h-full items-end justify-around gap-2 px-2">
            {payments.map((payment, index) => (
              <div
                key={`${payment}-${index}`}
                className="w-[34px] rounded-t-md bg-[#0d91d9]"
