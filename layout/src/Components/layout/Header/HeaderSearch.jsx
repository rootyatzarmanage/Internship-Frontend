...
export default function HeaderSearch() {
    return (
        <label className="flex h-[23px] w-[260px] max-w-[45vw] min-w-0 items-center gap-2 rounded-[4px] border-[0.5px] border-[#bbbbbb] bg-white px-2 text-black dark:border-[#303030] dark:bg-[#151515] dark:text-gray-100">
            ...
            />
            <div className="hidden h-[16px] min-w-[20px] shrink-0 items-center justify-center rounded-[2px] border border-[#9f9f9f] bg-white px-1.5 pt-0.5 text-[10px] leading-none text-[#aeb0b4] dark:border-[#3a3a3a] dark:bg-[#202020] dark:text-gray-300 sm:ml-auto sm:flex">
                ⌘K
            </div>
        </label>
    )
